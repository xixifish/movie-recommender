...
2. Get the first load of movies
...
Generate vectors for each movie from their text information: `genres`, `tagline`, `overview`, `keywords`, `reviews`, `credits`, and calculate the similarity score between the query vector and the movie vector.
