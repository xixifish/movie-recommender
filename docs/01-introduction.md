...
(start from an idea -> tap -> get an interested movie list -> leave)
## The Loop
...
## Experiment
Before building the product, I need to do some experiments to see if the assumption could work or not. 
### How search works
...
Before building the product, it’s necessary to do some experiments to see how the text information of movies works for the searching. 
